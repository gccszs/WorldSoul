...
<a id="deepseek-aidsh-worldsoul-gateway"></a>

## `@deepseek-ai/dsh-worldsoul-gateway`

需要：`agents` · `credentials` · `webServer` · `systemPrompt` · `tools`
...
来源：[`packages/worldsoul/gateway/src/index.ts:24`](../packages/worldsoul/gateway/src/index.ts)
...
- `@deepseek-ai/dsh-worldsoul-app`（[`packages/bundle/worldsoul-app/src/index.ts`](../packages/bundle/worldsoul-app/src/index.ts)）
